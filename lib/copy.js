...
export const copy = {
  ...
  hero: {
    ...
    badge: "Nowa książka z przepisami · +3 200 kursantów",
    headline: {
    ...
    subheadline:
      "Odkryj 500 przepisów na miękkie, puszyste i pyszne ciasta, całkowicie bez glutenu, nabiału i cukru, aby cieszyć się każdym kęsem bez bólu brzucha, wyrzutów sumienia czy ograniczeń.",
    ctaLabel: "TAK, CHCĘ TĘ KSIĄŻKĘ",
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Krok po kroku przez cały proces pieczenia" },
    ],
  },

  samples: {
    kicker: "Spróbuj ich najpierw",
    headline: "NIEZIEMSKO PYSZNE CIASTA (CZYSTA WERSJA):",
  ...
  moreRecipesCta: {
    ...
    ctaLabel: "POBIERZ SWÓJ EGZEMPLARZ",
  },

  testimonials: {
    kicker: "Prawdziwe opinie",
    headline: "ZOBACZ, CO MÓWIĄ CI, KTÓRZY JUŻ KUPILI",
    subheadline: "Czym dzielą się nasi kursanci",
    studentsBadge: "+ 3200 certyfikowanych kursantów",
    items: [
      {
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 Słynnych ciast z TikToka",
        items: [
          { src: "/preview/1-7.webp", alt: "Ciasto z TikToka 1" },
          { src: "/preview/2-6.webp", alt: "Ciasto z TikToka 2" },
          { src: "/preview/3-5-1.webp", alt: "Ciasto z TikToka 3" },
          { src: "/preview/4-3.webp", alt: "Ciasto z TikToka 4" },
        ],
      },
      {
  ...
  story: {
    ...
    paragraphs: [
      ...
      "Jako dietetyczka postanowiłam razem z mamą przerobić te przepisy na bezpieczne wersje: bez cukru, bez glutenu i bez laktozy. Po wielu próbach osiągnęłyśmy rezultaty, które zaskoczyły nawet samą babcię Zosię.",
  ...
  bonuses: {
    ...
    secretBonus: {
      ...
      name: "Ekskluzywne niespodzianki dla tych, którzy kupią książkę z przepisami już dziś",
      price: "250 zł",
      freeLabel: "DZIŚ ZA DARMO",
  ...
  finalCta: {
    ...
    includes: [
      ...
      "+ 67 PRZEPISÓW NA SOKI DETOKSYKUJĄCY",
    ],
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "🚫", text: "A także na tablecie." },
      { icon: "♾️", text: "Dożywotni dostęp: Razem z nowymi przepisami." },
  ...
  guarantee: {
    kicker: "Bez ryzyka",
    headline: "WYPRÓBUJ BEZ RYZYKA — 60-dniowa bezwarunkowa gwarancja.",
    body: "Masz 60 dni na ich przetestowanie. Jeśli przepisy Cię nie przekonają, zwrócę Ci pieniądze co do grosza. Bez komplikacji. Bez stresu.",
    alt: "Pieczęć 60-dniowej bezwarunkowej gwarancji",
    image: { src: "/guarantee-badge.webp", alt: "60 dni gwarancji" },
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Większość zajmuje 20 lub 30 minut. Zanim zrobisz sobie kawę, ciasto już będzie pachnieć w kuchni.",
      },
    ],
  },
